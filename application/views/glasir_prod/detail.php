...
<tr>
        ...
        <th rowspan="2" style="font-size:10px">Berat Kering (Kg)</th>
        <th rowspan="2" style="font-size:10px">Ball Mill</th>
        <th rowspan="2" style="font-size:10px">Turun Ke</th>
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <a href="<?php echo base_url();?>index.php/glasir_prod/editDetail/<?php echo $db['no_prod'];?>/<?php echo $db['id_glasir'];?>/<?php echo $db['idphd'];?>">
