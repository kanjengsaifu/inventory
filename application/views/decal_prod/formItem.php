...
$(document).ready(function(){
	...
	$("#simpan").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url	: "<?php echo site_url(); ?>/decal_prod/simpanItem",
			data	: string,
			cache	: false,
			success	: function(data){
				$.messager.show({
...
<td valign="top" width="50%">
    ...
    <tr>    
        ...
        <td>:</td>
        <td><input readonly="readonly" type="text" name="jml" id="jml"  size="45" class="easyui-numberbox" data-options="min:0,precision:0" style="text-align:right;" value="<?php echo $jml;?>" /></td>
    </tr>
    <tr>    
...
<tr>
    ...
    <a href="<?php echo base_url();?>index.php/decal_prod/edit/<?php echo $id;?>">
