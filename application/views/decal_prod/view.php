...
<a href="<?php echo base_url();?>index.php/decal_prod/tambah">
...
<form name="form" method="post" action="<?php echo base_url();?>index.php/decal_prod">
...
<tr>
        ...
        <th colspan="4" align="center" style="font-size:10px">Produksi</th>
...
<?php
	if($data->num_rows()>0){
		...
		$proses = $this->dclModel->ProsesDecal($db['id_related']);
                $prosesItem = $this->dclModel->ProsesItem($db['id_related']);
		$jml1 = $this->dclModel->JmlDecalKW1($db['id_related']);
                $jml2 = $this->dclModel->JmlDecalKW2($db['id_related']);
                $jml3 = $this->dclModel->JmlDecalKW3($db['id_related']);
                $jml4 = $this->dclModel->JmlDecalKW4($db['id_related']);
    	...
    	<tr>
			...
			?>
            <a href="<?php echo base_url();?>index.php/decal_prod/edit/<?php echo $db['id_related'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>index.php/decal_prod/hapus/<?php echo $db['id_related'];?>"
