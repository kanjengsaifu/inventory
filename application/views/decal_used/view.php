...
<tr>
        ...
        <th colspan="4" align="center" style="font-size:10px">Pemakaian</th>
...
<?php
	if($data->num_rows()>0){
		...
		$jml1 = $this->dclModel->JmlDecalKW1Used($db['id_related']);
                $jml2 = $this->dclModel->JmlDecalKW2Used($db['id_related']);
                $jml3 = $this->dclModel->JmlDecalKW3Used($db['id_related']);
                $jml4 = $this->dclModel->JmlDecalKW4Used($db['id_related']);
