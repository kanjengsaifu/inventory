...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <a href="<?php echo base_url();?>index.php/decal_used/editDetail/<?php echo $db['id_related'];?>/<?php echo $db['id_decal_items'];?>/<?php echo $db['batch'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>index.php/decal_used/hapus_detail/<?php echo $db['id_related'];?>/<?php echo $db['id_decal_items'];?>/<?php echo $db['batch'];?>"
