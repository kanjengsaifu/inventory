...
<tr>
        ...
        <th colspan="4" align="center" style="font-size:10px">Transit</th>
...
<?php
	if($data->num_rows()>0){
		...
		$jml1 = $this->dclModel->JmlDecalKW1Tran($db['id_related']);
                $jml2 = $this->dclModel->JmlDecalKW2Tran($db['id_related']);
                $jml3 = $this->dclModel->JmlDecalKW3Tran($db['id_related']);
                $jml4 = $this->dclModel->JmlDecalKW4Tran($db['id_related']);
