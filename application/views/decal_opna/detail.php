...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <a href="<?php echo base_url();?>index.php/decal_opna/editDetail/<?php echo $db['id_related'];?>/<?php echo $db['parent_id'];?>/<?php echo $db['id_group'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>index.php/decal_opna/hapus_detail/<?php echo $db['id_related'];?>/<?php echo $db['parent_id'];?>/<?php echo $db['id_group'];?>"
			...
			<img src="<?php echo base_url();?>asset/images/del.png" title='Hapus'>
                ...
                <tr>                                                                                
                            ...
                            <a href="<?php echo base_url();?>index.php/decal_opna/editItem/<?php echo $db['id_related'];?>/<?php echo $dx['parent_id'];?>/<?php echo $dx['id_group'];?>/<?php echo $dx['item_code'];?>/<?php echo $dx['id'];?>">
                                        <img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
                                        </a>
                            </td>
                </tr>        
