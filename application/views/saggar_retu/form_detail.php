...
$(document).ready(function(){
	...
	function tampil_data(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/glasir_tran/DataDetailHistory",
	...
	$("#simpan").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/glasir_tran/simpanStatus",
			data	: string,
			cache	: false,
			success	: function(data){
				$.messager.show({
...
<tr>
    ...
    <a href="<?php echo base_url();?>index.php/glasir_tran/edit/<?php echo $no_prod;?>">
