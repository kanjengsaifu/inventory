...
<tr>    
	<td>Nama Decal</td>
    <td>:</td>
    <td><input type="text" name="nama" id="nama"  size="45" maxlength="50" class="easyui-validatebox" data-options="required:true,validType:'length[3,50]'" value="<?php echo $nama;?>"/></td>
</tr>
<tr>    
	<td>Nama Alias</td>
    <td>:</td>
    <td><input type="text" name="alias" id="alias"  size="45" maxlength="50" class="easyui-validatebox" data-options="required:false,validType:'length[3,50]'" value="<?php echo $alias;?>"/></td>
</tr>
<tr>    
	<td>Nama Buyer</td>
    <td>:</td>
