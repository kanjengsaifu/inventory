...
$(document).ready(function(){
	...
	function tampil_data(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/decal_scra/DataDetail",
			data	: "kode="+kode,
			cache	: false,
	...
	$("#simpan").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url	: "<?php echo site_url(); ?>/decal_scra/simpan",
			data	: string,
			cache	: false,
			success	: function(data){
				$.messager.show({
	...
	$("#cetak").click(function(){
		...
		window.open('<?php echo site_url();?>/decal_scra/cetak/'+kode);
		return false();
	});
...
<td valign="top" width="50%">
    ...
    <tr>    
        <td>Petugas</td>
        <td>:</td>
        <td><input style="width: 350px;" id="petugas" class="easyui-combobox" name="petugas" data-options="required:true,valueField:'petugas',textField:'petugas',url:'<?php echo base_url().'index.php/decal_scra/getPicScraDecal'?>'"  value="<?php echo $petugas;?>" ></td>
    </tr>
    <tr>    
