...
<a href="<?php echo base_url();?>index.php/decal_scra/tambah">
<button type="button" name="tambah" id="tambah" class="easyui-linkbutton" data-options="iconCls:'icon-add'">Tambah</button>
</a>
<a href="<?php echo base_url();?>index.php/decal_scra">
<button type="button" name="refresh" id="refresh" class="easyui-linkbutton" data-options="iconCls:'icon-reload'">Refresh</button>
</a>

</div>
<div style="float:right; padding-bottom:5px;">
<form name="form" method="post" action="<?php echo base_url();?>index.php/decal_scra">
...
<?php
	if($data->num_rows()>0){
		...
		$proses = $this->dclModel->ProsesDecalScra($db['id_related']);
                $prosesItem = $this->dclModel->ProsesItemScra($db['id_related']);
		$jml1 = $this->dclModel->JmlScraJML($db['id_related']);
                $jml2 = $this->dclModel->JmlScraRusak($db['id_related']);
    	...
    	<tr>
			...
			?>
            <a href="<?php echo base_url();?>index.php/decal_scra/edit/<?php echo $db['id_related'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>index.php/decal_scra/hapus/<?php echo $db['id_related'];?>"
