...
<a href="<?php echo base_url();?>index.php/glasir_scra/tambah">
...
<form name="form" method="post" action="<?php echo base_url();?>index.php/glasir_scra">
...
<?php
	if($data->num_rows()>0){
		...
		$proses = $this->glzModel->ProsesGlasirScra($db['no_prod']);
                $prosesItemSupp = $this->glzModel->ProsesItemScra($db['no_prod']);
		$jml = $this->glzModel->JmlGlasirScra($db['no_prod']);
    	...
    	<tr>
			...
			?>
            <a href="<?php echo base_url();?>index.php/glasir_scra/edit/<?php echo $db['no_prod'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>index.php/glasir_scra/hapus/<?php echo $db['no_prod'];?>"
