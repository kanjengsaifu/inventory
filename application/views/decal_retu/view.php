...
<a href="<?php echo base_url();?>index.php/decal_retu/tambah">
...
<form name="form" method="post" action="<?php echo base_url();?>index.php/decal_retu">
...
<tr>
        ...
        <th colspan="4" align="center" style="font-size:10px">Retur</th>
...
<?php
	if($data->num_rows()>0){
		...
		$proses = $this->dclModel->ProsesDecalRetu($db['id_related']);
                $prosesItem = $this->dclModel->ProsesItemRetu($db['id_related']);
		$jml1 = $this->dclModel->JmlDecalKW1Retu($db['id_related']);
                $jml2 = $this->dclModel->JmlDecalKW2Retu($db['id_related']);
                $jml3 = $this->dclModel->JmlDecalKW3Retu($db['id_related']);
                $jml4 = $this->dclModel->JmlDecalKW4Retu($db['id_related']);
    	...
    	<tr>
			...
			?>
            <a href="<?php echo base_url();?>index.php/decal_retu/edit/<?php echo $db['id_related'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>index.php/decal_retu/hapus/<?php echo $db['id_related'];?>"
