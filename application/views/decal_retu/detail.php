...
<tr>
    ...
    <th style="font-size:10px">P. Conveyer</th>
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <td align="center" style="font-size:10px"><?php echo $db['jns_bm']; ?></td>
            ...
            <a href="<?php echo base_url();?>index.php/decal_retu/editDetail/<?php echo $db['id_related'];?>/<?php echo $db['id_decal_items'];?>/<?php echo $db['batch'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>index.php/decal_retu/hapus_detail/<?php echo $db['id_related'];?>/<?php echo $db['id_decal_items'];?>/<?php echo $db['batch'];?>"
