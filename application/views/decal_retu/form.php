...
<td valign="top" width="50%">
    ...
    <tr>    
        <td>Petugas</td>
        <td>:</td>
        <td><input style="width: 350px;" id="petugas" class="easyui-combobox" name="petugas" data-options="required:true,valueField:'petugas',textField:'petugas',url:'<?php echo base_url().'index.php/decal_retu/getPicRetuDecal'?>'"  value="<?php echo $petugas;?>" ></td>
    </tr>
    <tr>    
