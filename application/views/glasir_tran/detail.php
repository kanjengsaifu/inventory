...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <td align="right" style="font-size:10px"><?php echo number_format($db['volume']); ?></td>
            <td align="right" style="font-size:10px"><?php echo number_format($db['densitas']); ?></td>
...
<tr>
	<th colspan="8" align="center" style="font-size:10px">Total</th>
        <th style="text-align:right;font-size:10px"><?php echo number_format($g_total);?></th>
</tr>    
</table>