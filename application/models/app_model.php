...
class App_Model extends CI_Model {
	...
	public function row_detail($jenis){
		$q = $this->db->query("SELECT * FROM barang WHERE id_jenis='$jenis'");
		$r = $q->num_rows();
		return $r;
	}
	
	public function group_row_detail($jenis){
		$q = $this->db->query("SELECT * FROM barang WHERE id_jenis='$jenis'");
		//$r = $q->num_rows();
		return $q;
	}
	
	public function data_barang($jenis){
		$q = $this->db->query("SELECT * FROM barang WHERE id_jenis='$jenis'");
		//$r = $q->num_rows();
		return $q;
	}
	...
	public function jenis_barang(){
		$q = $this->db->get("jenis_barang");
		return $q;
	}
        
        public function status_glasir(){
		$q = $this->db->get("glasir_status");
		return $q;
	}
	
	public function nama_jenis_barang($id){
		$q = $this->db->query("SELECT * FROM jenis_barang WHERE id_jenis='$id'");
		$r = $q->num_rows();
		if($r>0){
