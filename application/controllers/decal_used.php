...
class Decal_used extends CI_Controller {
        ...
        public function DataDetail()
	{
		...
		if(!empty($cek)){
			...
			$text1 = "SELECT a.id,a.id_group,a.tgli,a.jam,a.id_related,a.parent_id,a.item_code,sum(a.isi_motif) as isi_motif,sum(a.jml) as jml,sum(a.rusak) as rusak,a.shift,a.area,a.id_bm,a.id_bmt,a.petugas,a.inputer from decal_uhd a  
