...
class Prod_glasir extends CI_Controller {
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$text = "SELECT * FROM ph_glasir $where ";		
			$tot_hal = $this->app_model->manualQuery($text);		
			
			$d['tot_hal'] = $tot_hal->num_rows();
			
			$config['base_url'] = site_url() . '/prod_glasir/index/';
			...
			$d['content'] = $this->load->view('prod_glasir/view', $d, true);		
	...
	public function tambah()
	{
		...
		if(!empty($cek)){
			...
			$no_prod    = $this->app_model->MaxPhGlasir();
			...
			$gps = "SELECT * FROM gps";
			$d['l_gps'] = $this->app_model->manualQuery($gps);
                        $bm = "SELECT * FROM bm";
			$d['l_bm'] = $this->app_model->manualQuery($bm);
                        $tong = "SELECT * FROM tong";
			$d['l_tong'] = $this->app_model->manualQuery($tong);
			
			$d['content'] = $this->load->view('prod_glasir/form', $d, true);		
			$this->load->view('home',$d);
		}else{
			header('location:'.base_url());
		}
