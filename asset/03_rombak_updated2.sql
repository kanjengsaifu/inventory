...
INSERT INTO `ci_sessions` (`session_id`, `ip_address`, `user_agent`, `last_activity`, `user_data`) VALUES
	('9df498e67f4f3edb0116d011a7c5bc48', '::1', 'Mozilla/5.0 (Windows NT 6.3; WOW64; rv:40.0) Gecko/20100101 Firefox/40.0', 1441196732, 'a:6:{s:9:"user_data";s:0:"";s:9:"logged_in";s:13:"aingLoginYeuh";s:8:"username";s:5:"admin";s:12:"nama_lengkap";s:13:"Administrator";s:4:"foto";s:9:"admin.jpg";s:5:"level";s:2:"01";}'),
	('ffd99b905fa4e4e500287b68aa5c00c8', '::1', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.157 Safari/537.36', 1441196796, 'a:6:{s:9:"user_data";s:0:"";s:9:"logged_in";s:13:"aingLoginYeuh";s:8:"username";s:5:"admin";s:12:"nama_lengkap";s:13:"Administrator";s:4:"foto";s:9:"admin.jpg";s:5:"level";s:2:"01";}');
...
-- Dumping data for table inventory.glasir_phd: ~15 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `glasir_phdh` (
  ...
  CONSTRAINT `FK_glasir_phdh_glasir_patt` FOREIGN KEY (`idgps`) REFERENCES `global_status` (`idgps`),
...
INSERT INTO `glasir_phd_sp` (`idphd`, `no_prod`, `id_glasir`, `id_bm`, `id_gps`, `volume`, `densitas`, `inputer`, `dsc`, `petugas`, `tgl_insert`) VALUES
	(21, 'SG00001', 'Y00011', 42, 2, 31.94888178913738, 1500, 'admin', 'Ok', 'zainudin', '2015-08-22 11:21:52'),
	(23, 'SG00002', 'Y00001', 43, 2, 127.7955271565495, 1500, 'admin', 'ditambah', 'zainudin', '2015-08-24 07:52:34'),
	(25, 'SG00004', 'Y00001', 42, 2, 31.94888178913738, 1500, 'admin', 'Kebutuhan export', 'zainudin', '2015-08-28 05:04:14'),
	(35, 'SG00003', 'Y00002', 42, 2, 63.89776357827475, 1500, 'admin', 'Monyong', 'Jeni', '2015-09-02 01:37:01'),
	(40, 'SG00005', 'Y00003', 42, 2, 31.94888178913738, 1500, 'admin', 'belekok', 'lina', '2015-09-02 01:57:59'),
	(41, 'SG00004', 'Y00003', 43, 2, 63.89776357827475, 1500, 'admin', 'luna', 'lonja', '2015-09-02 01:58:46');
...
INSERT INTO `glasir_ph_sp` (`no_prod`, `inputer`, `tgl_inp`, `lst_upd`) VALUES
	...
	('SG00006', 'admin', '2015-09-02 07:26:26', '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `glasir_rhdh` (
  ...
  CONSTRAINT `glasir_rhdh_ibfk_2` FOREIGN KEY (`idgps`) REFERENCES `global_status` (`idgps`),
...
CREATE TABLE IF NOT EXISTS `glasir_thdh` (
  ...
  CONSTRAINT `glasir_thdh_ibfk_2` FOREIGN KEY (`idgps`) REFERENCES `global_status` (`idgps`),
